...
return <div className="contact" style={sectionStyle}  >
 ...
 <body className="contactBody">   
        ...
        <a className='tel' href="tel:+33609614477">+33609614477</a></p>
          ...
          <input type="text" className="name entry " placeholder="Votre Nom"/>
          
          <input type="text" className="email entry" placeholder="Email"/>
          
          <textarea className="message entry" placeholder="Message"></textarea> 
